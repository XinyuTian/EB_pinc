...
string<-system(intern=TRUE,command=paste('Rscript ~/Dropbox/My\\ ','R\\ ','Code/EB_pinc/calc_lik.R ./',i,'/toPredict/samples_FacData.tab ./',i,'/G1_model/all/factorPotentials.txt',sep=""))
samples_G1_likelihoods <- as.numeric(string)
...
string<-system(intern=TRUE,command=paste('Rscript ~/Dropbox/My\\ ','R\\ ','Code/EB_pinc/calc_lik.R ./',i,'/toPredict/samples_FacData.tab ./',i,'/G2_model/all/factorPotentials.txt',sep=""))
samples_G2_likelihoods <- as.numeric(string)
